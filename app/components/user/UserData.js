...
const UserData = ({ email, image, name, lastname, city, address, phone, item }) => {
  ...
  return (
    <div className={`w-1/2 min-w-72 p-8 gap-4 rounded-3xl flex flex-wrap flex-col justify-center items-center bg-gray-700 bg-opacity-25`}>
        ...
        <div className='flex justify-center items-center gap-4 flex-wrap'>
          <Image priority={false} src={image ? image : "/no-image.webp"} alt={"imagen profile autoshop"} width={230} height={230}/>
